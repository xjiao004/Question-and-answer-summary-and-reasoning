...
import argparse
from seq2seq_tf2.train_eval_test import train
from seq2seq_tf2.train_eval_test import test
...
def main():
    ...
    # others
    parser.add_argument("--steps_per_epoch", default=2543, help="max_train_steps", type=int)
